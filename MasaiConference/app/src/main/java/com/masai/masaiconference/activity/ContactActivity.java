...
import com.masai.masaiconference.contactAdapterModel.ContactRVAdapter;
import com.masai.masaiconference.contactAdapterModel.ContactsModal;
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport multiplePermissionsReport) {
                        ...
                        if (multiplePermissionsReport.areAllPermissionsGranted()) {
                            // do you work now
                            getContacts();
                            Toast.makeText(ContactActivity.this, "All the permissions are granted..", Toast.LENGTH_SHORT).show();
                        }
