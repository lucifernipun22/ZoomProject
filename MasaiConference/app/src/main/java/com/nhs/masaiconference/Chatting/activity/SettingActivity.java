...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.update_status_appbar);
        toolbar = findViewById(R.id.update_status_appbar);
...
//edit photo
        ...
        saveInfoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                saveInformation(uName,  uPhone,  selectedGender);
            }
        });
        ...
        editStatusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent statusUpdateIntent = new Intent(SettingActivity.this, StatusUpdateActivity.class);
    ...
    private void saveInformation(String uName, String uPhone, String uGender) {
        if (uGender.length()<1){
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Task<Uri> thumbUriTask = thumb_uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task){
                                    if (!task.isSuccessful()){
                                        SweetToast.error(SettingActivity.this, "Thumb Image Error: " + task.getException().getMessage());
                                    }
                ...
                // handling more event
                SweetToast.info(SettingActivity.this,"Image cropping failed.");
            }
        }
