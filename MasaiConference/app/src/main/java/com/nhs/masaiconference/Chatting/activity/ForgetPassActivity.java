...
public class ForgetPassActivity extends AppCompatActivity {
        ...
        resetPassButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    SweetToast.error(ForgetPassActivity.this, "Email is required");
                } else if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    SweetToast.error(ForgetPassActivity.this,"Email format is not valid.");
                } else {
                    ...
                    auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                new Timer().schedule(new TimerTask(){
                                    public void run() {
                                        ForgetPassActivity.this.runOnUiThread(new Runnable() {
                                            public void run() {
                                                auth.signOut();
                                                Intent mainIntent =  new Intent(ForgetPassActivity.this, LoginActivity.class);
                                                mainIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                                startActivity(mainIntent);
                                                finish();
                                                SweetToast.info(ForgetPassActivity.this, "Please check your email.");
                                            }
                                        });
                                    }
                                }, 8000);
                        ...
                        public void onFailure(@NonNull Exception e) {
                            SweetToast.error(ForgetPassActivity.this, "Oops!! "+e.getMessage());
                        }
                    });
                }
            }
    ...
    private void emailSentSuccessPopUp() {
        ...
        View view = LayoutInflater.from(ForgetPassActivity.this).inflate(R.layout.register_success_popup, null);
